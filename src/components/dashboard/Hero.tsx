...
export default function Hero(
  ...
  return (
    <div 
    ref={observerRef}
    className='text-base flex flex-col md:p-6 md:m-auto gap-y-5 h-screen'
      id='home'
    >
      <div className='midScreen:leading-[3rem] leading-[3.5rem] tracking-wide font-mono text-cyan-200'>
